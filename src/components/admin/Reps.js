		...
		return (
			...
			<form onSubmit = {this.handleSubmit}  style={{padding: 15, backgroundColor: "#eee"}}>
				...
				<div className="input-field">
					<label htmlFor="name" className="active">Representative Name</label>
					<input type="text" id="name" value={this.state.name} onChange={this.handleChange} required/>
				</div>

				<div className="input-field">
					<label htmlFor="description" className="active">Description</label>
					<textarea style={{minHeight: 100}} id="description" value={this.state.description} onChange={this.handleChange}/>
				</div>

				<div className="input-field">
					<label htmlFor="photo_url" className="active">Photo URL</label>
					<input type="text" id="photo_url" value={this.state.photo_url} onChange={this.handleChange}/>
				</div>
